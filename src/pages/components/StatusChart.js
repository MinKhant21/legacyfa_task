...
export default function StatusChart() {
  return (
    <div className="  h-[250px] mt-12 flex gap-5 justify-between  items-center bg[#F5F5F5]">
      <div className=" w-[400px] h-[255px]  bg-[#F5F5F5] gap-4  py-4 shadow-lg  rounded-2xl">
        <img src={Customer} className=" h-[190px] rounded-2xl w-full" alt="" />
      </div>
      <div className=" p-3 w-[700px]  bg-[#F5F5F5] gap-4   shadow-lg h-[255px] rounded-2xl">
      ...
      <div className=" p-3    bg-[#F5F5F5] gap-4  py-4 shadow-lg h-[255px] rounded-2xl">
        <img src={target} className=" h-[200px] rounded-2xl w-full" alt="" />
      </div>
    </div>
  );
}
